<div class="home__main-content" id="<?php echo $contextTheme; ?>">
    <div class="home__background-image">
        ...
        <a href="/task/app/Views/pages/register/register.php" class="home__register-button">
            Regístrate ;)
        </a>
    </div>
</div>
<div class="home__feature-card" id="organizacion">
    <div class="home__feature-content">
        <h3 class="home__feature-title">Organización</h3>
...
<div class="home__feature-card" id="recordatorios">
    <div class="home__feature-content">
        <h3 class="home__feature-title">Recordatorios</h3>
        <p class="home__feature-description">
...
<div class="home__feature-card" id="accesibilidad">
    <div class="home__feature-content">
        <h3 class="home__feature-title">Accesibilidad</h3>
        <p class="home__feature-description">
